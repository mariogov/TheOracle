...
use crate::types::fingerprint::semantic::{
    SemanticFingerprint, TeleologicalArray, E10_DIM, E11_DIM, E12_TOKEN_DIM, E14_DIM, E1_DIM,
    E2_DIM, E3_DIM, E4_DIM, E5_DIM, E6_SPARSE_VOCAB, E7_DIM, E8_DIM, E9_DIM,
};
use crate::types::fingerprint::SparseVector;

/// Test: EmbeddingRef correctly categorizes all 14 embeddings.
#[test]
...
fn test_storage_bytes() {
    ...
    // Dense: E1-E5, E7-E11, E14, with dual E5/E8/E10 vectors
    // for asymmetric cause/effect, source/target, and paraphrase/context roles.
    let dense_floats = E1_DIM
        + E2_DIM
        + E3_DIM
        + E4_DIM
        + E5_DIM
...
fn test_storage_bytes_with_sparse() {
    ...
    // Calculate expected size:
    // With E14 and dual E5/E8/E10 vectors.
    let dense_floats = E1_DIM
        + E2_DIM
        + E3_DIM
        + E4_DIM
...
fn test_bincode_serialization_roundtrip() {
    ...
    assert_eq!(
        ...
        deserialized.e10_multimodal_paraphrase
    );
    assert_eq!(
        fp.e10_multimodal_as_context,
        deserialized.e10_multimodal_as_context
    );
...
fn test_validate_strict_sparse_unsorted_passes() {
    ...
    assert!(
        result.is_ok(),
        "unsorted but in-bounds indices should pass validation"
    );
...
fn test_validate_strict_sparse_duplicate_passes() {
    ...
    assert!(
        result.is_ok(),
        "duplicate but in-bounds indices should pass validation"
    );
