...
pub enum CodeEntityType {
    ...
    /// Module definition.
    Module,
    /// Namespace or package declaration.
    Namespace,
    ...
    /// Comment block.
    Comment,
    /// Documentation string or documentation comment.
    Docstring,
    /// Mixed AST chunk spanning multiple entity classes.
    Mixed,
...
impl CodeEntityType {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::Enum => "enum",
            Self::Trait => "trait",
            Self::TraitOrInterface => "trait_or_interface",
            Self::Impl => "impl",
            Self::Const => "const",
            Self::Static => "static",
            Self::TypeAlias => "type",
    ...
    pub fn is_callable(&self) -> bool {
        matches!(
            self,
            Self::Function | Self::Method | Self::Macro | Self::Test
        )
    }
