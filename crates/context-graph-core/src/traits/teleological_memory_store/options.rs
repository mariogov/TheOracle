...
pub struct TeleologicalSearchOptions {
    ...
    /// Custom per-embedder weights `[f32; 14]` for multi-space search.
    ///
    ...
    #[serde(default)]
    pub custom_weights: Option<[f32; 14]>,
    ...
    #[serde(default)]
    pub synergy_weights: Option<[f32; 14]>,
...
impl TeleologicalSearchOptions {
    ...
    #[inline]
    pub fn with_custom_weights(mut self, weights: [f32; 14]) -> Self {
    ...
    pub fn with_synergy_weights(mut self, weights: [f32; 14]) -> Self {
...
mod tests {
    ...
    fn test_search_options_default() {
        ...
        assert_eq!(
            opts.fusion_strategy,
            crate::fusion::FusionStrategy::WeightedRRF
        );
    }
    ...
    fn test_search_options_fusion_strategy() {
        ...
        assert_eq!(
            opts.fusion_strategy,
            crate::fusion::FusionStrategy::WeightedSum
        );
