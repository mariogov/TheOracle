...
#![allow(dead_code)] // DTOs kept for legacy compatibility while E5 tools fail closed.
...
mod tests {
    ...
    fn test_causal_chain_hop_with_content() {
        let hop = CausalChainHop::new(Uuid::nil(), 0, 0.8, 0.85, 1.0, CausalDirection::Unknown);
